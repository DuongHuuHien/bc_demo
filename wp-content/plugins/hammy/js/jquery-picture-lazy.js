        ...
        this.each(function(){
            ...
            function setPicture(){
                ...
                if(element.find('img').length == 0){
                    ...
                    var prep = '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-original="' + sizes[currentMedia] + '" style="' + element.attr('style') + '" alt="' + element.attr('alt') + '" class="lazy">';
            ...
            function setFigure(){
                ...
                if(element.find('img').length == 0){
	                // Display a transparent gif before loading image (made it a data URI to avoid an other HTTP request).
	                // Add the lazy class to the img.
                    var prep = '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-original="' + sizes[currentMedia] + '" alt="' + element.attr('title') + '" class="lazy">';
